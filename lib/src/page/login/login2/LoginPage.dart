...
final TextEditingController passwordController =TextEditingController();
  ...
  //     value: 'Español',
  //     code: 'ES',
  //     iconPath: 'assets/imagenes/ecuador.jpeg',
  //   ),
  //   LanguageOption(
  //     value: 'English',
  //     code: 'EN',
  ...
  // String get _username => language.code == 'ES' ? 'Usuario' : 'Username';
  //
  // String get _login => language.code == 'ES' ? 'Ingresar' : 'Login';
  //
  // String get _signup => language.code == 'ES' ? 'Registrarse' : 'Sign Up';
  //
  // String get _title => language.code == 'ES' ? 'Bienvenidos' : 'Welcome';
